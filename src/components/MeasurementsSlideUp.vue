    ...
    <div class="measurements-slide-up__container">
      <div class="measurements-slide-up__container__header d-flex flex-column">
        ...
        <div class="mt-3 d-block">
          <span class="measurements-slide-up__container__header__site-name text-truncate d-inline">{{ $t('slider.site_name') }}{{ siteName }}</span>
        </div>
      </div>
      <hr />
      ...
      <div class="measurements-slide-up__container__suggestions">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12 text-center measurements-slide-up__container__suggestions__title"><span class="lead">{{ $t('slider.activity_suggestions') }}</span></div>
